FROM python:3.10.13 AS foundation
...
CMD mlflow server --backend-store-uri sqlite:///:memory --default-artifact-root ./mlruns --host=0.0.0.0 --port=5000 --app-name basic-auth
